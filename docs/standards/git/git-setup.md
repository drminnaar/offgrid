...
This document provides a comprehensive guide for setting up and using Git on Linux based systems. The guide can be mostly followed for Windows systems too.
