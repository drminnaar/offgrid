...
/// <summary>
/// Represents a product in the product MongoDB catalog.
/// </summary>
public sealed class Product : IMongoEntity
{
    [BsonId]
    ...
    [BsonIgnore]
    public long CreatedAtUnixTimeSeconds => Id.CreationTime.ToUnixTimeSeconds();

    [BsonIgnore]
    public int TotalStockQuantity => Variants.Sum(v => v.StockQuantity);
    ...
    public string StockLevel
    {
        get
        {
            var totalStock = TotalStockQuantity;
            return totalStock switch
            {
                > 20 => "In Stock",
                > 0 and <= 20 => "Limited Stock",
                _ => "Out of Stock"
            };
        }
    }
