...
using Offgrid.Portal.ProductSearch.Infrastructure.Configuration;
using Offgrid.Portal.ProductSearch.Infrastructure.Persistence.Typesense;
...
{
    private static IServiceCollection AddTypeSenseInfrastructure(
        this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSingleton<IProductSearchIndexer, ProductSearchIndexer>();
